...
void read_from_file_and_send(int fd_out, char *input_file) {
...
void write_to_file_and_close(int fd_in, char *output_file) {
    char buffer[BUFFER_SIZE];
    ssize_t bytes_read;
...
int main(int argc, char *argv[]) {
    ...
    read_from_file_and_send(pipe1[1], input_file);
    ...
    write_to_file_and_close(pipe2[0], output_file);
